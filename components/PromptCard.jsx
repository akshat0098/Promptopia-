...
const PromptCard = ({post,handleEdit,handleDelete,handleTagClick}) => {
    ...
    const handleProfileClick = () => {
        ...
        router.push('/profile/${post.creator_id}?name=${post.creator.username}');
        ...
        <div className="promp_card">
            <div className="flex justify-between items-start gap-5" >
                ...
                <div className="copy_btn" onClick={handleCopy}  >
                    <Image src={copied === post.prompt ? "/assets/icons/tick.svg" : "/assets/icons/copy.svg" } alt = {copied == post.prompt ?  "tick_icon" : "copy_icon"} 
                    width = {12}
                    height = {12}
                    />
                </div>
            ...
            <p className="my-4 font-satoshi text-sm text-gray-700" > {post.promt}  </p>
